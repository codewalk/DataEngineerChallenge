...
public class Application {
	...
	public static void main(String[] args) {
		...
		if(outputDataPath == null){
			//D:\projects\DataEngineerChallenge\output\
		...
		if(inputFile == null){
//			D:\projects\DataEngineerChallenge\data\2015_07_22_mktplace_shop_web_log_sample.log.gz
		 ...
		 */
		//df.groupBy("client_ip").avg("diff_event_millisec").show(1000, 0);;
